...
google.maps.Marker.prototype.animateTo = function(newPosition, oldlatitude,oldlongitude, latitude, longitude, options) {
  defaultOptions = {
    duration: 1000,
    easing: 'linear',
    complete: null
  ...
  this.AT_startPosition_lat = oldlatitude;
  this.AT_startPosition_lng = oldlongitude;
  var newPosition_lat = latitude;
  var newPosition_lng = longitude;
